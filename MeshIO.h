...
namespace ITI {
	...
	class MeshIO{
            public:
                 ...
                 * 
                 */
                static void createRandom3DMesh(scai::lama::CSRSparseMatrix<ValueType> &adjM, vector<DenseVector<ValueType>> &coords, int numberOfPoints, ValueType maxCoord);
                
                static void createStructured3DMesh(CSRSparseMatrix<ValueType> &adjM, vector<DenseVector<ValueType>> &coords, std::vector<ValueType> maxCoord, std::vector<IndexType> numPoints);
                ...
                */
                 ...
                 */
                static void writeInFileCoords (const vector<DenseVector<ValueType>> &coords, IndexType dimension, IndexType numPoints, const string filename);
                ...
                static void readFromFile2AdjMatrix_Boost( lama::CSRSparseMatrix<ValueType> &matrix, dmemo::DistributionPtr  distribution, const string filename);
                 ...
                 */
                static void fromFile2Coords_2D( const string filename, vector<DenseVector<ValueType>> &coords, IndexType numberOfCoords);
                ...
                */
                static void fromFile2Coords_3D( const string filename, vector<DenseVector<ValueType>> &coords, IndexType numberOfPoints);
