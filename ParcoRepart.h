	...
	class ParcoRepart {
		public:
			...
			*/
			...
			static ValueType distributedFMStep(const CSRSparseMatrix<ValueType> &input, DenseVector<IndexType> &part, IndexType k, ValueType epsilon, bool unweighted = true);
	};
}
