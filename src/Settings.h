...
*/
enum class Tool { geographer, geoKmeans, geoKmeansBalance, geoHierKM, geoHierRepart, geoSFC, geoMS, geoRebalance, parMetisGraph, parMetisGeom, parMetisSFC, parMetisRefine, zoltanRIB, zoltanRCB, zoltanMJ, zoltanXPulp, zoltanSFC, parhipFastMesh, parhipUltraFastMesh, parhipEcoMesh, myAlgo, none, unknown};
